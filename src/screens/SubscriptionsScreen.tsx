...
const SubscriptionsScreen = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.title}>Suscripciones y servicios</Text>
      <FlatList
        data={subscriptions}
        keyExtractor={(item) => item.id}
        refreshControl={<RefreshControl refreshing={isLoading} onRefresh={loadSubscriptions} />}
        renderItem={({ item }) => (
        ...
        ListEmptyComponent={
          !isLoading ? (
            <Text style={styles.emptyText}>Agrega tus suscripciones para planificar mejor.</Text>
          ) : null
        }
